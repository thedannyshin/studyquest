...
const generateSamples: GenerateSample[] = [
  {
    id: 'systems-connection-circles',
    title: 'How connection circles reveal hidden systems',
    materialLabel: 'Interconnected Circles Map',
    materialType: 'PDF',
    classCode: 'Systems',
    video: '/How_Connection_Circles_Reveal_Hidden_Systems.mp4',
  },
  {
    id: 'systems-mental-models',
    title: 'How mental models automate decisions',
    materialLabel: 'Mental Models and Cluster Maps',
    materialType: 'Slides',
    classCode: 'Systems',
    video: '/How_Mental_Models_Automate_Decisions.mp4',
  },
  {
    id: 'systems-ai-agents',
    title: 'Why AI agents are killing traditional UX',
    materialLabel: 'Experiment #2: AI Agents',
    materialType: 'PDF',
    classCode: 'Systems',
    video: '/Why_AI_Agents_Are_Killing_Traditional_UX.mp4',
  },
]
...
const posts: Post[] = [
  {
    ...
    video: '/How_System_Structure_Drives_Behavior.mp4',
  ...
  },
  {
    ...
    video: '/How_to_Reframe_Artificial_Constraints.mp4',
    postedBy: 'StudyQuest AI',
  },
  {
    id: 8,
